...
import { TiPlus,  PiShoppingCartBold, BsDashCircleFill, TbBus, BsBoxSeam, PiCurrencyNgn } from "../icon";
            ...
            <ul className=" mobile:hidden flex gap-4 text-[13px] font-Inter font-semibold ">
              ...
              <div className="">
                ...
                <div className="flex justify-between">
                        ...
                        <div className="flex h-32 gap-[133px] mt-2">
                            <span className="flex gap-2">
                                ...
                                <span className="pl-1">
                                    ...
                                    <button className="border-x-0 border-t-0 border-b-2 text-sm mr-4 text-[#98A2B3] border-[#98A2B3]  ">Edit</button>

                                    <button className="border-x-0 border-t-0 border-b-2 text-sm text-error border-error   ">Remove</button>
                                </span>
                            </span>
                            ...
                            <div className="flex gap-5 h-10 items-center border border-rblue px-2  rounded">
                                    ...
                                    <FaPlus
                                     size={8} className=' mt-[3.5px] ml-[3.5px] cursor-pointer '/>
                                    </span>
                                </div>
                                </div>
                            ...
                            <span className="flex gap-2">
                                ...
                                <span className="pl-1">
                                    <h1 className="font-semibold text-lg pt-4 pb-0.5">Joyce Set</h1>
                                    <p className="pb-1 w-full text-[11px] font-medium">Color: Pink, Blue </p>
                            ...
                            <div className="flex gap-5 h-10 items-center border border-rblue px-2  rounded">
                                    ...
                                    <span className="border w-[18px] h-[18px]  bg-blue-500 text-white rounded-full ">
                                    <FaPlus
                                     size={8} className=' mt-[3.5px] ml-[4px] cursor-pointer '/>
                                    </span>
                                </div>
                                </div>
                    ...
                    <div className="pt-4 ml-3 ">
                        ...
                        <div className="mt-5">
                            <h3 className="text-xs mb-3 font-medium ">Promo & Discount</h3>
                            <input type="text" className=" py-1 text-[#667085] h-8 w-52 text-xs pl-2 bg-[#F2F4F7]  " placeholder='Enter Promo Code' />
                        </div>

                        <Link to="/checkout">
                        <button className="rounded-md mt-8  bg-blue-700 text-white py-2 px-20 text-sm ">Checkout</button>
                        </Link>
                    </div>
              ...
              <hr className='border-[#D0D5DD] mb-5' />
                ...
                <div className="bg-sblue py-5 px-6 mx-4 ">
                    ...
                    <p className="text-center text-[13px] p">Guarantee safe and secure checkout</p>
                </div>
